    ...
    public class OutputFile
    {
        ...
        public List<Result> Parse()
        {
            try
            {
                ...
                else if (!(this.PAMLVersion.Major == 4 && (this.PAMLVersion.Minor == 8 || this.PAMLVersion.Minor == 9 || this.PAMLVersion.Minor == 10)) || this.PAMLVersion.Major != 4)
                {
                ...
                if (this.PAMLVersion.Major == 4 && this.PAMLVersion.Minor == 9)
                {
                    Parse_4_8();
                }
                // UPDATE: The if... statement above is no longer commented out because version 4.10 is now supported
                if (this.PAMLVersion.Major == 4 && this.PAMLVersion.Minor == 10)
                {
                    Parse_4_10();
                }
            }
            ...
            try
            {
                using (StreamReader reader = new StreamReader(this.FilePath))
                {
                    ...
                    while (!reader.EndOfStream)
                    {
                        ...
                        //"Time used" no longer found in out.txt for newer version
